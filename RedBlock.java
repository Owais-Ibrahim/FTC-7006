...
public class RedBlock extends LinearOpMode {
    ...
    {
        EncodedStraightDrive(24,0.8);
        sleep(100);
        EncodedStrafe(-12,0.8);//Negative for right and positive for left
        GrabBlock(32,0.5);
        robot.Push.setPower(1.0);
        sleep(600);
        EncodedStraightDrive(-33,0.7);
        robot.Grabber.setPosition(1.0);
        robot.Push.setPower(0);
        sleep(50);
        TurnAbsolute(280,0.5,2);
        EncodedStraightDrive(-45,0.8);
        sleep(100);
        EncodedStrafe(-22,0.8);
        PlaceBlock();
    ...
    {
        EncodedStrafe(22,0.7);
        sleep(100);
        TurnAbsolute(280,0.5,2);
        EncodedStraightDrive(56,0.7);
        sleep(100);
        EncodedStrafe(-21,0.8);
        GrabBlock(10,0.4);
        EncodedStraightDrive(-5,0.8);
        robot.Push.setPower(1.0);
        sleep(800);
        robot.Grabber.setPosition(1.0);
        robot.Push.setPower(0);
        EncodedStrafe(25,0.8);
        TurnAbsolute(280,0.2,2);
        EncodedStraightDrive(-52,0.7 );
        sleep(100);
        EncodedStrafe(-22,1.0);
        PlaceBlock();
        Park();
    ...
    {
        EncodedStrafe(23,1.0);
        EncodedStraightDrive(15,1.0);
    }
