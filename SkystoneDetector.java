...
public class SkystoneDetector extends LinearOpMode {
    ...
    /**
     * Uses Back camera to detect the skystone
     * Hold 3 positions and displays that info on the driver station phone
     * right,center,left
     * if value is 0 then its a skystone
     * if 255 then its a normal stone
     */
